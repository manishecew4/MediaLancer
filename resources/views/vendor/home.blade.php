                        ...
                        <a class="card tdn" href="{{ route('user.emp_details', ['id' => $item['id']]) }}">
                            <div class="card_img pr">
                                ...
                                <img src="{{ asset('/') }}assets/{{ $item['avatar'] }}" class="profile_thumb"
                                    alt="">
                                <span class="d-flex empRating aic fw-bold">1.5 / 5</span>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card_img pr">
                                <div class="vcSlide pr">
                                    <div class="pr test-vd h-100" id="v1">
                                        <video preload="auto" loop class="card-img-top" alt="...">
                                            <source src="{{ isset($item['video']->path) ? $item['video']->path : ''  }}" type="video/mp4">
                                        </video>
                                    </div>
                                </div>
                                <img src="{{ asset('/') }}assets/{{ $item['avatar'] }}" class="profile_thumb"
                                    alt="">
                                <span class="d-flex empRating aic fw-bold">4.5 / 5</span>
                            </div>
                            <div class="card-body">
                                <h5 class="card-title mb-0">{{ $item['name'] }}</h5>
                                <p class="card-text">{{ $item['basic']['info'] }}</p>
