...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ asset('/') }}sample/#">
                ...
                <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link nav-link-1 active"
                            onclick="photoSample({{ $_GET['vendor_id'] }});">Photos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-2 " aria-current="page"
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll"
        data-image-src="{{ asset('/') }}sample/img/hero.jpg">
