                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#cat" aria-expanded="false"
                            ...
                            <span class="menu-title">Categories / Sub..</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="cat">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('admin.category') }}">Categories & Sub..</a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('admin.list_category') }}">All List</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="employee">
                            <ul class="nav flex-column sub-menu">
                                {{-- <li class="nav-item"> <a class="nav-link" href="">Employee Add</a></li> --}}
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('admin.emp_list') }}">Employee List</a></li>
                            </ul>
                        </div>
                    </li>
